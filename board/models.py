...
class Application(models.Model):
    ...
    art_name1 = models.CharField(max_length=100, verbose_name='작품1 제목')
    art_name2 = models.CharField(max_length=100, verbose_name='작품2 제목', null=True, blank=True)
    art_name3 = models.CharField(max_length=100, verbose_name='작품3 제목', null=True, blank=True)
    art_name4 = models.CharField(max_length=100, verbose_name='작품4 제목', null=True, blank=True)
    art_name5 = models.CharField(max_length=100, verbose_name='작품5 제목', null=True, blank=True)
